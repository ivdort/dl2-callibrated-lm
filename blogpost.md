...
Recently, people have been noticing a large amount of false information generated by language models (LMs), such as non-existent article references. This has been described as "hallucinations" of LMs. This has caused problems in different fields where LMs are applied, especially in fields such as healthcare, hallucinations can be life-threatening. A recent study \cite{Kalai2023} provided a mathematical analysis of the problem and derived a lower bound on the hallucination rate of LMs, showing that there is a trade-off between calibration accuracy and hallucination rate. 
